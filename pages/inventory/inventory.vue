<template>
	<view class="page-container">
		<titleNView title="盘点" titleIcon="/static/nav_stocktaking.png"></titleNView>
	...
	export default {
		...
		methods: {
			...
			startInventory() {
				...
				uni.navigateTo({
					url: `/pages/inventoryDetails/inventoryDetails?id=${this.sideListData[this.curIdx][0].value}&ContainerNum=${this.sideListData[this.curIdx][1].value} `,
				});
			},
		},
		onShow: function() {
			this.tipchange = false;
			this.tipword = "";
			PDA_InventoryTasklist().then((res) => {
